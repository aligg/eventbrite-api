...
#https://www.eventbriteapi.com/v3/events/search/?location.address=san+francisco&location.within=10mi&token=OIYFDLTDLQ4DJ5P7OGUZ
...
def find_afterparties():
    ...
    if location and distance and measurement:
        ...
        payload = {'token' : EVENTBRITE_TOKEN, 'location.address' : location, 'location.within': distance}
